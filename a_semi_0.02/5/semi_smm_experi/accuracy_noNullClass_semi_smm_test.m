...
clear all;
clc;
if exist('confuMat_smm_frame_testt.txt') == 2
    delete('confuMat_smm_frame_test.txt');
end
if exist('confuMat_smm_event_test.txt') == 2
    delete('confuMat_smm_event_test.txt');
end
if exist('micro_macro_frame_test.txt') == 2
    delete('micro_macro_frame_test.txt');
end
if exist('micro_macro_event_test.txt') == 2
    delete('micro_macro_event_test.txt');
end
...
fID_save = fopen('accuracy_smm_test.csv','w+');
fID_confusionMat_frame = fopen('confuMat_smm_frame_test.txt','a+');
fID_confusionMat_event = fopen('confuMat_smm_event_test.txt','a+');
fID_micro_macro_frame = fopen('micro_macro_frame_test.txt','a+');
fID_micro_macro_event = fopen('micro_macro_event_test.txt','a+');
...
fID_all_names = fopen('precomputedK_smm_names_test.txt','r');
...
fprintf(fID_save,'%f(%d/%d)\n', accuracy_smm, tmp_frame, length(group_t));
